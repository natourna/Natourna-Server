...
namespace NatrounaServer.Data
{
    /// <summary>
    /// Database context for Natrouna Server System.
    /// Manages all entities and their relationships for building, apartment, payment, and financial operations.
    /// </summary>
    public class NatrounaServerContext : DbContext
    {
        ...
        public NatrounaServerContext(DbContextOptions<NatrounaServerContext> options) : base(options) { }
